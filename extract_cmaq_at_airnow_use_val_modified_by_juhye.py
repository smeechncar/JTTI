...
def main(date_beg, date_end):
	...
	cmaq_dir = pathlib.Path('/','glade','scratch','jkim','CMAQ','cmaq_hourly_prep_anen')
	...
	for tt in range(n_times):
		...
		cmaq_fname_in_this   = cmaq_dir.joinpath('cmaq_9variables_'+this_yyyymmddhh+'.nc')
...
#			print('Reading '+str(cmaq_fname_in_this))
		...
		cmaq_t2m_deg_spline = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_t2m_this, kx=1, ky=1)
		cmaq_t2m_deg_airnow_use = cmaq_t2m_deg_spline.ev(cmaq_j_pm25_use, cmaq_i_pm25_use)
		cmaq_t2m_deg_spline_o3 = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_t2m_this, kx=1, ky=1)
		cmaq_t2m_deg_airnow_use_o3 = cmaq_t2m_deg_spline_o3.ev(cmaq_j_o3_use, cmaq_i_o3_use)

		cmaq_ws10m_deg_spline = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_ws10m_this, kx=1, ky=1)
		cmaq_ws10m_deg_airnow_use = cmaq_ws10m_deg_spline.ev(cmaq_j_pm25_use, cmaq_i_pm25_use)
		cmaq_ws10m_deg_spline_o3 = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_ws10m_this, kx=1, ky=1)
		cmaq_ws10m_deg_airnow_use_o3 = cmaq_ws10m_deg_spline_o3.ev(cmaq_j_o3_use, cmaq_i_o3_use)

		cmaq_wd10m_deg_spline = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_wd10m_this, kx=1, ky=1)
		cmaq_wd10m_deg_airnow_use = cmaq_wd10m_deg_spline.ev(cmaq_j_pm25_use, cmaq_i_pm25_use)
		cmaq_wd10m_deg_spline_o3 = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_wd10m_this, kx=1, ky=1)
		cmaq_wd10m_deg_airnow_use_o3 = cmaq_wd10m_deg_spline_o3.ev(cmaq_j_o3_use, cmaq_i_o3_use)

		cmaq_swdown_deg_spline = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_swdown_this, kx=1, ky=1)
		cmaq_swdown_deg_airnow_use = cmaq_swdown_deg_spline.ev(cmaq_j_pm25_use, cmaq_i_pm25_use)
		cmaq_swdown_deg_spline_o3 = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_swdown_this, kx=1, ky=1)
		cmaq_swdown_deg_airnow_use_o3 = cmaq_swdown_deg_spline_o3.ev(cmaq_j_o3_use, cmaq_i_o3_use)

		cmaq_pbl_deg_spline = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_pbl_this, kx=1, ky=1)
		cmaq_pbl_deg_airnow_use = cmaq_pbl_deg_spline.ev(cmaq_j_pm25_use, cmaq_i_pm25_use)
		cmaq_pbl_deg_spline_o3 = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_pbl_this, kx=1, ky=1)
		cmaq_pbl_deg_airnow_use_o3 = cmaq_pbl_deg_spline_o3.ev(cmaq_j_o3_use, cmaq_i_o3_use)

		cmaq_nox_deg_spline = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_nox_this, kx=1, ky=1)
		cmaq_nox_deg_airnow_use = cmaq_nox_deg_spline.ev(cmaq_j_pm25_use, cmaq_i_pm25_use)
		cmaq_nox_deg_spline_o3 = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_nox_this, kx=1, ky=1)
		cmaq_nox_deg_airnow_use_o3 = cmaq_nox_deg_spline_o3.ev(cmaq_j_o3_use, cmaq_i_o3_use)

		cmaq_noy_deg_spline = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_noy_this, kx=1, ky=1)
		cmaq_noy_deg_airnow_use = cmaq_noy_deg_spline.ev(cmaq_j_pm25_use, cmaq_i_pm25_use)
		cmaq_noy_deg_spline_o3 = sp.interpolate.RectBivariateSpline(cmaq_j_arr, cmaq_i_arr, cmaq_noy_this, kx=1, ky=1)
		cmaq_noy_deg_airnow_use_o3 = cmaq_noy_deg_spline_o3.ev(cmaq_j_o3_use, cmaq_i_o3_use)
		...
		cmaq_str = 'CMAQ gridded forecast'
		...
		cmaq_t2m_con_use = xr.DataArray(cmaq_t2m_deg_airnow_use,
                                                                        coords={'n_obs_use_pm25':n_use_pm25}, dims=['n_use_pm25'],
                                                                        attrs={'description':cmaq_str+' 2m Temperatre interpolated to AirNow PM2.5 stations used for merging', 'units':'K'})
		cmaq_t2m_con_use_o3 = xr.DataArray(cmaq_t2m_deg_airnow_use_o3,
                                                                        coords={'n_obs_use_o3':n_use_o3}, dims=['n_use_o3'],
                                                                        attrs={'description':cmaq_str+' 2m Temperatre interpolated to AirNow O3 stations used for merging', 'units':'K'})
		cmaq_ws10m_con_use = xr.DataArray(cmaq_ws10m_deg_airnow_use,
                                                                        coords={'n_obs_use_pm25':n_use_pm25}, dims=['n_use_pm25'],
                                                                        attrs={'description':cmaq_str+' 10m Wind speed interpolated to AirNow PM2.5 stations used for merging', 'units':'m s-1'})
		cmaq_ws10m_con_use_o3 = xr.DataArray(cmaq_ws10m_deg_airnow_use_o3,
                                                                        coords={'n_obs_use_o3':n_use_o3}, dims=['n_use_o3'],
                                                                        attrs={'description':cmaq_str+' 10m Wind speed interpolated to AirNow O3 stations used for merging', 'units':'m s-1'})
		cmaq_wd10m_con_use = xr.DataArray(cmaq_wd10m_deg_airnow_use,
                                                                        coords={'n_obs_use_pm25':n_use_pm25}, dims=['n_use_pm25'],
                                                                        attrs={'description':cmaq_str+' 10m Wind direction interpolated to AirNow PM2.5 stations used for merging', 'units':'degree'})
		cmaq_wd10m_con_use_o3 = xr.DataArray(cmaq_wd10m_deg_airnow_use_o3,
                                                                        coords={'n_obs_use_o3':n_use_o3}, dims=['n_use_o3'],
                                                                        attrs={'description':cmaq_str+' 10m Wind direction interpolated to AirNow O3 stations used for merging', 'units':'degree'})
		cmaq_swdown_con_use = xr.DataArray(cmaq_swdown_deg_airnow_use,
                                                                        coords={'n_obs_use_pm25':n_use_pm25}, dims=['n_use_pm25'],
                                                                        attrs={'description':cmaq_str+' SWDOWN interpolated to AirNow PM2.5 stations used for merging', 'units':'W m-2'})
		cmaq_swdown_con_use_o3 = xr.DataArray(cmaq_swdown_deg_airnow_use_o3,
                                                                        coords={'n_obs_use_o3':n_use_o3}, dims=['n_use_o3'],
                                                                        attrs={'description':cmaq_str+' SWDOWN interpolated to AirNow O3 stations used for merging', 'units':'W m-2'})
		cmaq_pbl_con_use = xr.DataArray(cmaq_pbl_deg_airnow_use,
                                                                        coords={'n_obs_use_pm25':n_use_pm25}, dims=['n_use_pm25'],
                                                                        attrs={'description':cmaq_str+' PBL interpolated to AirNow PM2.5 stations used for merging', 'units':'m'})
		cmaq_pbl_con_use_o3 = xr.DataArray(cmaq_pbl_deg_airnow_use_o3,
                                                                        coords={'n_obs_use_o3':n_use_o3}, dims=['n_use_o3'],
                                                                        attrs={'description':cmaq_str+' PBL interpolated to AirNow O3 stations used for merging', 'units':'m'})
		cmaq_nox_con_use = xr.DataArray(cmaq_nox_deg_airnow_use,
                                                                        coords={'n_obs_use_pm25':n_use_pm25}, dims=['n_use_pm25'],
                                                                        attrs={'description':cmaq_str+' NOX interpolated to AirNow PM2.5 stations used for merging', 'units':'ppmb'})
		cmaq_nox_con_use_o3 = xr.DataArray(cmaq_nox_deg_airnow_use_o3,
                                                                        coords={'n_obs_use_o3':n_use_o3}, dims=['n_use_o3'],
                                                                        attrs={'description':cmaq_str+' NOX interpolated to AirNow O3 stations used for merging', 'units':'ppmb'})
		cmaq_noy_con_use = xr.DataArray(cmaq_noy_deg_airnow_use,
                                                                        coords={'n_obs_use_pm25':n_use_pm25}, dims=['n_use_pm25'],
                                                                        attrs={'description':cmaq_str+' NOY interpolated to AirNow PM2.5 stations used for merging', 'units':' '})
		cmaq_noy_con_use_o3 = xr.DataArray(cmaq_noy_deg_airnow_use_o3,
                                                                        coords={'n_obs_use_o3':n_use_o3}, dims=['n_use_o3'],
                                                                        attrs={'description':cmaq_str+' NOY interpolated to AirNow O3 stations used for merging', 'units':' '})
		## Create new xarray datasets
		ds_use = xr.Dataset(
						data_vars={ 'cmaq_pm25_con_use':cmaq_pm25_con_use, 'cmaq_o3_con_use':cmaq_o3_con_use,
										'cmaq_t2m_con_use':cmaq_t2m_con_use, 'cmaq_t2m_con_use_o3':cmaq_t2m_con_use_o3, #JH
										'cmaq_ws10m_con_use':cmaq_ws10m_con_use, 'cmaq_ws10m_con_use_o3':cmaq_ws10m_con_use_o3, #JH
										'cmaq_wd10m_con_use':cmaq_wd10m_con_use, 'cmaq_wd10m_con_use_o3':cmaq_wd10m_con_use_o3, #JH
										'cmaq_swdown_con_use':cmaq_swdown_con_use, 'cmaq_swdown_con_use_o3':cmaq_swdown_con_use_o3, #JH
										'cmaq_pbl_con_use':cmaq_pbl_con_use, 'cmaq_pbl_con_use_o3':cmaq_pbl_con_use_o3, #JH
										'cmaq_nox_con_use':cmaq_nox_con_use, 'cmaq_nox_con_use_o3':cmaq_nox_con_use_o3, #JH
										'cmaq_noy_con_use':cmaq_noy_con_use, 'cmaq_noy_con_use_o3':cmaq_noy_con_use_o3, #JH
